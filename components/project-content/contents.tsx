  ...
  return (
    <>
      <section id="architecture" className="mb-6">
        ...
        ※ 게시물 기능은 사용자가 작성중인 게시물을 임시로 저장하는 <b>초안 단계</b>와 실제로 등록하는 <b>발행 단계</b>로 나뉩니다.
        ...
        <b> 중복 동기화를 방지</b>하고 시간 복잡도를 O(N)에서 O(1)로 최적화했습니다. 또한 <b>Redis 파이프라인</b>을 적용하여 IO 성능을 개선함으로써 1000개의 요청을 기준으로 약 1450ms에서 264ms로 단축했습니다.
        <br/>
        <b>Cache Aside</b> 전략을 통해 실시간 데이터 조회와 다중 기기 간 작업 연속성을 보장했으며, TTL을 활용하여 임시 데이터의 생명 주기를 관리했습니다.
        <br/><br/>
        게시물 발행(publish) 시 Unique Constraint를 적용하여 <b>중복 요청을 방지</b>하여 멱등성을 보장했습니다. 그와 동시에 Redis에 저장된 데이터를 즉시 삭제하여 메모리 효율성 또한 높였습니다.
        </div>
      </section>
