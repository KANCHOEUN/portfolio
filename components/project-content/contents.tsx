  ...
  return (
    <>
      <section id="architecture" className="mb-6">
        ...
        <br/>
        <div>
        <b>사용자 입력</b> 시 발생하는 DB 부하를 줄이기 위해 <b>Write Behind</b> 전략을 적용한 자동 저장 시스템을 구현하였습니다.
        <br/>
        ...
        <b> 중복 동기화를 방지</b>하고 시간 복잡도를 <b>O(N)에서 O(1)로 최적화</b>했습니다. 또한 <b>Redis 파이프라인</b>을 적용하여 <b>IO 성능을 개선</b>함으로써 1000개의 요청을 기준으로 <b>약 1450ms에서 264ms로 단축</b>했습니다.
        <br/>
        <b>Cache Aside</b> 전략을 통해 실시간 데이터 조회와 다중 기기 간 작업 연속성을 보장했으며, <b>TTL을 활용</b>하여 임시 데이터의 생명 주기를 관리했습니다.
        <br/><br/>
        <b>게시물 발행</b>(publish) 시 <b>Unique Constraint</b>를 적용하여 <b>중복 요청을 방지</b>하여 멱등성을 보장했습니다. 그와 동시에 Redis에 저장된 데이터를 즉시 삭제하여 메모리 효율성 또한 높였습니다.
        </div>
      </section>
